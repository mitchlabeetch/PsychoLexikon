...
import { KonditionierungVergleich } from '@/components/svgs/Subject04SVGs';
...
export default function Subject04() {
  const subject = useMemo(() => subjectsData.find((s) => s.id === '04'), []);
