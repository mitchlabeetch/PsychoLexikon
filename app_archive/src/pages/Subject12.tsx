...
import { Subject12SVG1, Subject12SVG2 } from '@/components/svgs/Subject12SVGs';
...
export default function Subject12() {
  const subject = subjectsData.find(s => s.id === '12');
    ...
    <article className="pb-8">
      ...
      {content_blocks.map((block, idx) => {
        switch (block.type) {
          ...
          case 'visual': {
            visualCount++;
            const SvgComponent = visualCount === 1 ? Subject12SVG1 : Subject12SVG2;
            return (
