...
import { GestaltgesetzeDemo, FigureGrundReversibilitaet } from '@/components/svgs/Subject02SVGs';
...
export default function Subject02() {
  const subject = useMemo(() => subjectsData.find((s) => s.id === '02'), []);
    ...
    <article className="font-body text-text-primary">
      ...
      <nav className="mb-6" aria-label="Breadcrumb">
        <ol className="flex items-center gap-2 font-body text-[0.875rem] text-text-muted">
          <li><Link to="/" className="hover:underline">PSYCHLERN</Link></li>
          <li>/</li>
