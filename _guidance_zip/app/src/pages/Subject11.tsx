...
import { Subject11SVG1, Subject11SVG2 } from '@/components/svgs/Subject11SVGs';
...
export default function Subject11() {
  const subject = subjectsData.find(s => s.id === '11');
    ...
    <article className="pb-8">
      ...
      {content_blocks.map((block, idx) => {
        switch (block.type) {
          ...
          case 'visual': {
            visualCount++;
            const SvgComponent = visualCount === 1 ? Subject11SVG1 : Subject11SVG2;
            return (
