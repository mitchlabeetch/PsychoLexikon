...
import { ArbeitsgedaechtnisModell } from '@/components/svgs/Subject03SVGs';
...
export default function Subject03() {
  const subject = useMemo(() => subjectsData.find((s) => s.id === '03'), []);
