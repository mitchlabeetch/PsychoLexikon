...
import { BISMatrixSVG } from '@/components/svgs/Subject05SVGs'

/* ------------------------------------------------------------------ */
/* Inline tooltip (dotted underline, no forced bg)                     */
/* ------------------------------------------------------------------ */
...
/* ------------------------------------------------------------------ */
/* Text processor: replaces **bold**, blue & red highlights             */
/* ------------------------------------------------------------------ */
function processParagraph(
  ...
  // 2) within each text chunk, split on blue/red terms (longest first)
  ...
  return (
    <section className="mb-8">
      {paragraphs.map((para: string, i: number) => {
        ...
        // Split into sentences (max 3 per paragraph)
...
/* Main page component                                                 */
/* ------------------------------------------------------------------ */
export default function Subject05() {
  const subject = subjectsData.find(s => s.id === '05')
