...
export const categories: Category[] = [
  ...
  },
  {
    ...
    metadata: {
      ...
      keywords: ['gestalt', 'prägnanz', 'arbeitsgedächtnis'],
  ...
  },
  {
    ...
    metadata: {
      ...
      keywords: ['validität', 'experiment', 'design'],
      crmSegment: 'methods',
    },
  },
  {
    ...
    metadata: {
      ...
      keywords: ['p-wert', 'reliabilität', 'validität'],
...
export const articleCategoryMap: Record<string, { categoryId: string; keywords: string[] }> = {
  ...
  '02': { categoryId: 'perception-and-cognition', keywords: ['gestaltgesetze', 'prägnanz', 'figur-grund'] },
  '03': { categoryId: 'perception-and-cognition', keywords: ['arbeitsgedächtnis', 'phonologische schleife', 'zentrale exekutive'] },
  '04': { categoryId: 'learning-and-development', keywords: ['konditionierung', 'verstärkung', 'lernen'] },
  '05': { categoryId: 'differential-and-personality', keywords: ['bis', 'intelligenzstruktur', 'jäger'] },
  ...
  '08': { categoryId: 'differential-and-personality', keywords: ['big five', 'traits', 'persönlichkeit'] },
  '09': { categoryId: 'research-methods', keywords: ['validität', 'experiment', 'kontrolle'] },
  '10': { categoryId: 'statistics-and-psychometrics', keywords: ['p-wert', 'alpha-fehler', 'beta-fehler'] },
  '11': { categoryId: 'statistics-and-psychometrics', keywords: ['objektivität', 'reliabilität', 'validität'] },
  '12': { categoryId: 'motivation-and-emotion', keywords: ['motivation', 'emotion', 'theorie'] },
  '13': { categoryId: 'differential-and-personality', keywords: ['hexaco', 'persönlichkeit', 'traits'] },
  '14': { categoryId: 'differential-and-personality', keywords: ['mischel', 'person-situation', 'persönlichkeit'] },
  '15': { categoryId: 'differential-and-personality', keywords: ['persönlichkeitstests', 'diagnostik', 'traits'] },
  '16': { categoryId: 'differential-and-personality', keywords: ['persönlichkeitsstörungen', 'klinisch', 'persönlichkeit'] },
