...
import { FigureGrundReversibilität, GestaltgesetzeDemo } from './Subject02SVGs'
import { ArbeitsgedächtnisModell } from './Subject03SVGs'
...
export const articleIllustrationRegistry: Record<string, SvgComponent> = {
  ...
  '02-visual-2': FigureGrundReversibilität,
  '03-visual-1': ArbeitsgedächtnisModell,
