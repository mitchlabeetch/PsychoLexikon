      ...
      className={({ isActive }) =>
        [
          ...
          compact
            ...
            : 'rounded-r-lg px-1.5 py-3 text-[clamp(0.5rem,1vh,0.7rem)] shadow-sm hover:translate-x-3',
          isActive || activeCategory === tab.label ? 'translate-x-3 shadow-[0_8px_20px_rgba(0,0,0,0.14)]' : '',
        ].join(' ')
      }
      style={{
        ...
        <div className="relative flex items-start">
          <div className="relative min-w-0 flex-1 bg-bg-page rounded-lg shadow-[0_4px_20px_rgba(0,0,0,0.15)] overflow-visible">
            ...
            <div className="absolute top-0 right-0 flex flex-col gap-3" style={{ transform: 'translateX(50%)' }}>
              <div className="sticky top-6 flex flex-col gap-3 ml-4 mt-6">
