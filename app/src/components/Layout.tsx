    ...
    <div className="min-h-[100dvh] bg-bg-outer flex justify-center overflow-x-clip pl-3 pr-6 py-6 sm:px-6 lg:px-8">
      <div className="w-full max-w-[1100px] relative">
        <div className="relative flex items-stretch gap-0">
          ...
          <div className="relative min-w-0 flex-1 min-h-[100dvh] pb-16 bg-bg-page rounded-lg shadow-[0_4px_20px_rgba(0,0,0,0.15)] overflow-visible z-10">
            <NotebookPage>
          ...
          <div className="z-0 shrink-0" style={{ transform: 'translateX(50%)' }}>
